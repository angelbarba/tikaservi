...
@Composable
fun PasajeroRecuperarPasswordScreen(onListo: () -> Unit, onVolver: () -> Unit) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text("Usuario, email, telefono o DNI") },
        ...
        if (!pasoDos) {
            ...
            Button(
                onClick = {
                    if (identificador.isBlank()) { error = "Ingresa tu usuario, email, telefono o DNI"; return@Button }
                    cargando = true; error = null
                    scope.launch {
                        try {
                            val resp = ApiClient.api.recuperarPasswordPasajero(
            ...
            Button(
                onClick = {
                    ...
                    scope.launch {
                        try {
                            val resp = ApiClient.api.restablecerPasswordPasajero(
